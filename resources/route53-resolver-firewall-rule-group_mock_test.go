...
func Test_Mock_Route53ResolverFirewallRuleGroup_List(t *testing.T) {
	...
	expectedFirewallRule1a := &Route53ResolverFirewallRule{ptr.String("test-rule"), ptr.String("vpc-123"), ptr.String("A"), nil}
	expectedFirewallRule2a := &Route53ResolverFirewallRule{ptr.String("block-malicious"), ptr.String("vpc-123"), nil, nil}
	...
	mockRoute53Resolver.EXPECT().ListFirewallRuleGroupAssociations(gomock.Any(), gomock.Any()).Return(&r53r.ListFirewallRuleGroupAssociationsOutput{
