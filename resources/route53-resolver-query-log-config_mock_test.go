...
func Test_Mock_Route53ResolverQueryLogConfig_List(t *testing.T) {
	...
	mockRoute53Resolver.EXPECT().ListResolverQueryLogConfigAssociations(gomock.Any(), gomock.Any()).Return(&r53r.ListResolverQueryLogConfigAssociationsOutput{
...
func Test_Mock_Route53ResolverQueryLogConfig_Properties(t *testing.T) {
	...
	a.Equal("rslvr-frg-3 (Internet Resolver)", frg.String())

	frg.Name = nil
	a.Equal("rslvr-frg-3 ()", frg.String())
}
